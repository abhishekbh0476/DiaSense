        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Empowering better diabetes management through intelligent technology and community support.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link href="/mobile" className="text-gray-400 hover:text-white transition-colors">Mobile App</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              <p>&copy; 2024 GlucoTrack. All rights reserved.</p>
            </div>
